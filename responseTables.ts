...
function pickEntryByTotal(table: readonly TableEntry[], total: number): TableEntry {
...
function getEntryById(rollType: RollType | string, entryId: string | null | undefined): TableEntry | null {
