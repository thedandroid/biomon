...
Output: server.ts with ~150-200 LOC (persistence inline, handlers delegated)
</objective>
...
6. server.ts is ~200 LOC (not 887 like original)
...
- Thin router pattern achieved (~200 LOC vs 887)
