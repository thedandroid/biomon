...
- Update test files pattern to include .ts
  ...
  <verify>
Run `npm run lint` - should complete without errors on all existing JS files. TypeScript linting will be verified when actual .ts files are created in later phases.
  </verify>
